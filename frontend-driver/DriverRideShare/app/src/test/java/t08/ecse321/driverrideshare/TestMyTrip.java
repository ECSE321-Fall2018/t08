...
public class TestMyTrip {
    ...
    private static final String PASSENGER_ID = "7;2";
    ...
    @Before
    public void setup() {
        item = new myTripContent.TripItem(TRIP_ID, TRIP_STATUS, COST_PER_STOP, START_DATE, END_DATE, START_LOCATION, STOPS, PASSENGER_ID);
    }

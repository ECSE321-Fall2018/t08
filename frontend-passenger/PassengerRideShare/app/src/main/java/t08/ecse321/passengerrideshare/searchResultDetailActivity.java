...
public class searchResultDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tripid = intent.getStringExtra(searchResultDetailFragment.ARG_ITEM_ID);

        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                    selectTrip(eusername, epassword, tripid);
                    }
        });
    ...
    public void selectTrip(String username, String password, String tripid) {
        RequestParams params = new RequestParams();
        params.add("tripid", tripid);
        params.add("username", username);
        params.add("password", password);

        //If select trip successful, want to return to main page (with finish())
        HttpUtils.post("api/trip/select", params, new JsonHttpResponseHandler() {
            @Override

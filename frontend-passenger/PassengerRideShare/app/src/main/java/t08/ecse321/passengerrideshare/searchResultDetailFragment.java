...
public class searchResultDetailFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            // Load the search result content specified by the fragment
            // arguments. In a real-world scenario, use a Loader
            // to load content from a content provider.
            mItem = searchResultContent.ITEM_MAP.get(getArguments().getString(ARG_ITEM_ID));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Show the search result content as text in a TextView.
        if (mItem != null) {
